...
namespace OIB.Tutorial
{
    public class ServiceHelper<T> : IDisposable where T : class
    {
        ...
        /// <param name="useClientAuthentication">True if client authentication should be used</param>
        ...
        private void AdjustBindingParameters(Binding binding, bool useSecurity)
        {
            ...
            if (bindHttp != null)
            {
                ...
                bindHttp.Security.Message.ClientCredentialType = _useClientAuthentication ? MessageCredentialType.Certificate : MessageCredentialType.None;
            }
            if (bindTcp != null)
            {
                ...
                // Usage of client authentication binding properties
                bindTcp.Security.Transport.ClientCredentialType = _useClientAuthentication
